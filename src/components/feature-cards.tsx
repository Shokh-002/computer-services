...
export default function Features() {
  ...
  return (
    <section className="w-full py-12 bg-white">
      <div className="container mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-4 px-4">
        {features.map((feature, index) => (
          <Card
            key={index}
            className="bg-[#062259] text-white p-6 rounded-2xl flex flex-col items-center justify-start text-center"
          >
